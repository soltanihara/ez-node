...
wget -O config.json "https://raw.githubusercontent.com/soltanihara/ez-node/main/etc/xray.json"
...
wget -O config.json "https://raw.githubusercontent.com/soltanihara/ez-node/main/etc/sing-box.json"
echo $sversion
...
wget -O config.yaml "https://raw.githubusercontent.com/soltanihara/ez-node/main/etc/hysteria.yaml"
